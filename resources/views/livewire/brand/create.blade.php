                                            ...
                                            <div id="collapse{{ $index }}" class="accordion-collapse collapse {{ $shouldShow ? 'show' : '' }}" aria-labelledby="heading{{ $index }}">
                                                <div class="accordion-body">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-md-6">
                                                            <x-file-upload model="adds.{{$index}}.brand_image" label="{{ __('messages.brand.create.label_brand_image') }}" note="Extensions: jpeg, png, jpg, gif, svg | Size: Maximum 4096 KB" classRequired='required' />
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <x-input type="color" wire:model="adds.{{$index}}.bg_color" class="form-control-color" id="bg_color_{{$index}}" />
