...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <a href="/dashboard" wire:navigate>
        <img alt="Logo" src="{{ image('logos/eastern_techno_solutions_logo.jpg') }}" class="h-40px app-sidebar-logo-default" />
        <img alt="Logo" src="{{ image('logos/eastern_techno_solutions_logo.jpg') }}" class="h-30px app-sidebar-logo-minimize" />
    </a>
    <!--end::Logo image-->
